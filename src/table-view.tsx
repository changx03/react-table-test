...
@observer
class ValueView extends React.Component<{ controller: any }, any> {
  render() {
    let { cellVal } = this.props.controller;
    return <h3>{cellVal}</h3>;
  }
}
...
class HeaderRow extends React.Component<any, any> {
  render() {
    ...
    return <tr>{headerValues.map(i => <HeaderCell key={i} value={i} />)}</tr>;
  }
}
...
class BodyCell extends React.Component<
  { value: any; onClick?(obj?: any): void; idx?: any },
  any
> {
  render() {
    return (
